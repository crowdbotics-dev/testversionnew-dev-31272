...
## Project Structure
    ...
    ├── testversionnew_dev_31272  # Django project configurations
...
1. Clone this repo and `cd testversionnew_dev_31272`
...
2. Clone this repo and `cd testversionnew_dev_31272`
